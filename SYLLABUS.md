...
- [x] [Pattern questions](https://youtu.be/lsOOs5J8ycw)
- [x] [Strings](https://www.youtube.com/watch?v=zL1DPZ0Ovlo)
...
- [x] [Maths for DSA](https://youtu.be/fzip9Aml6og)
...
- [x] [Recursion](https://www.youtube.com/playlist?list=PL9gnSGHSqcnp39cTyB1dTZ2pJ04Xmdrod)
    ...
    - [x] [Sorting](https://www.youtube.com/playlist?list=PL9gnSGHSqcnq-9CXLt9DsInytRMLoyZQ_)
...
- [x] [Space and Time Complexity Analysis](https://youtu.be/mV3wrLBbuuE)
